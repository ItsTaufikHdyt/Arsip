...
<?php
    ...
    $data1 = mysqli_query($dbconnect,"SELECT * FROM surat_masuk");
    while($data=mysqli_fetch_array($data1))
    {

    echo "<tr>";
    echo  "<td>" .$data['id_surat_masuk'], "</td>";
    ...
    echo  "<td>".
            "<a href='deletesuratmasuk.php?id_surat_masuk=$data[id_surat_masuk]' class='btn btn-danger btn-sm'>
                <span class='glyphicon glyphicon-trash'> Hapus</span></a>
           
            <a href='editsuratmasuk.php?id_surat_masuk=$data[id_surat_masuk]' class='btn btn-warning btn-sm'>
